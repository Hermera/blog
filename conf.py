...
BLOG_AUTHOR = "Hermera"  # (translatable)
BLOG_TITLE = "INCESSANT."  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://hermera.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hermera.github.io/"
BLOG_EMAIL = "HermeraWen@outlook.com"
BLOG_DESCRIPTION = "There is no remedy for love but to love more."  # (translatable)
